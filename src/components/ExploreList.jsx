...
const ExploreList = ({ item, index }) => {
  ...
  return (
    ...
    >
      <h3 className="text-2xl font-extrabold mb-4 uppercase tracking-wider leading-tight truncate">
        {item?.title}
      </h3>
      <div className="flex gap-3 flex-col">
        ...
        />
        <DetailList label="Kota" value={item?.city?.city_name_full} />
      </div>
    </motion.div>
  );
};
