      ...
      <section className="px-6 md:px-12 py-12 md:py-16 bg-white border-b-4 border-black mt-12">
        ...
        <div className="px-6 md:px-12 py-8 border-black bg-gray-100 mt-8">
          <div className="flex justify-center flex-col gap-4">
            <select className="border-4 border-black bg-white text-black text-lg font-bold uppercase px-4 py-3 w-full cursor-pointer shadow-[4px_4px_0px_black] transition-all hover:bg-black hover:text-white focus:outline-none focus:bg-black focus:text-white">
