  ...
  return (
    <div className="bg-white min-h-screen font-mono relative">
      ...
      <div className="max-w-3xl mx-auto text-white bg-black border-4 border-white shadow-[12px_12px_0_0_black] p-12 my-16 relative">
        <h1 className="text-7xl font-extrabold mb-10 uppercase border-b-4 border-white pb-3 tracking-widest">
          Profile
        </h1>
        <div className="flex flex-col gap-8">
          ...
          <button
            className="bg-white text-black border-4 border-black px-8 py-4 uppercase text-xl font-bold tracking-wide shadow-[6px_6px_0_0_black] hover:bg-gray-100 active:shadow-none active:translate-x-[6px] active:translate-y-[6px] transition-all"
